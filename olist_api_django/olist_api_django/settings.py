"""
Django settings for olist_api_django project.
...
ALLOWED_HOSTS = ['olist-api-django.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'olist_api_django.urls'
...
WSGI_APPLICATION = 'olist_api_django.wsgi.application'
